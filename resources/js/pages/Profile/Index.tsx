            ...
            {filteredPets.map((pet) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  {/* Owner actions: Edit / Cancel (if pending) / Delete */}
                  {isOwner && (
                    <div className="mt-3 flex flex-wrap gap-2">
                      {/* Edit: lahat except pending (same behavior as adoption index) */}
                      {pet.status !== 'pending' && (
                        <Link
                          href={route('adoption.edit', pet.id)}
